...
export default function ChannelsPage() {
  ...
  async function onCreate() {
    ...
    setErr(null);
    try {
      await AdminApi.createChannel({ name: name.trim() });
      setName("");
      await load();
    } catch (e: unknown) {
    ...
    <div style={styles.page}>
      <div style={styles.topRow}>
        <div>
          ...
          <p style={styles.sub}>Create and list TV/Radio channels.</p>
        </div>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.hint}>
          Backend not ready yet? This page will work automatically once your
          backend exposes <code>GET /api/v1/channels</code> and{" "}
          <code>POST /api/v1/channels</code>.
        </div>
      </div>
    </div>
  );
