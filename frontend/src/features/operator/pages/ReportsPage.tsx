...
export default function ReportsPage() {
  ...
  async function downloadReport() {
    ...
    try {
      ...
      const filename = `operator_report.${format}`;
    ...
    <div style={styles.page}>
      <div style={styles.topRow}>
        <div>
          ...
          <p style={styles.sub}>Generate compliance exports for operator workflows.</p>
        </div>
      </div>
      ...
      <div style={styles.card}>
        <div style={styles.formGrid}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end" }}>
            <button
              style={{ ...styles.primaryBtn, opacity: canRun ? 1 : 0.6 }}
        ...
        <div style={styles.hint}>
          This uses <code>POST /api/v1/reports/generate</code>.
        </div>
      </div>
    </div>
  );
